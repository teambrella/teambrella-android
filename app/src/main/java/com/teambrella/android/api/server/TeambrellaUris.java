...
public class TeambrellaUris {
    ...
    private static final String SEGMENT_SET_LIMIT = "setLimit";


    public static final String KEY_FACEBOOK_TOKEN = "facebookToken";
    public static final String KEY_AUTH0_TOKEN = "auth0Token";
    ...
    public static final int ME_REGISTER_FACEBOOK_KEY = 4;
    ...
    public static final int SET_COVERAGE_LIMIT = 55;
    ...
    static {
        ...
        sUriMatcher.addURI(AUTHORITY, SEGMENT_ME + "/" + SEGMENT_REGISTER_FACEBOOK, ME_REGISTER_FACEBOOK_KEY);
        sUriMatcher.addURI(AUTHORITY, SEGMENT_ME + "/" + SEGMENT_REGISTER_AUTH0, ME_REGISTER_AUTH0_KEY);
        ...
        sUriMatcher.addURI(AUTHORITY, SEGMENT_WALLET + "/" + SEGMENT_SET_LIMIT, SET_COVERAGE_LIMIT);
    ...
    public static Uri getRegisterUri(String facebookToken, String sigOfPublicKey) {
        return new Uri.Builder().authority(AUTHORITY)
                .appendEncodedPath(SEGMENT_ME)
                .appendEncodedPath(SEGMENT_REGISTER_FACEBOOK)
    ...
    public static Uri getRegisterAuth0Uri(String auth0Token, String sigOfPublicKey) {
        return new Uri.Builder().authority(AUTHORITY)
                .appendEncodedPath(SEGMENT_ME)
                .appendEncodedPath(SEGMENT_REGISTER_AUTH0)
                .appendQueryParameter(KEY_AUTH0_TOKEN, auth0Token)
                .appendQueryParameter(KEY_SIG_OF_PUBLIC_KEY, sigOfPublicKey)
                .build();
    }
    ...
    public static Uri getSetClaimLimitUri(int teamId, int claimLimit) {
        return new Uri.Builder()
                .authority(AUTHORITY)
                .appendEncodedPath(SEGMENT_WALLET)
                .appendEncodedPath(SEGMENT_SET_LIMIT)
                .appendQueryParameter(KEY_TEAM_ID, Integer.toString(teamId))
                .appendQueryParameter(KEY_LIMIT, Integer.toString(claimLimit))
                .build();
    }
    ...
    public static Uri getNotificationSettingUri(int teamId) {
        return new Uri.Builder()
                .authority(AUTHORITY)
                .appendEncodedPath(SEGMENT_FEED)
                .appendEncodedPath(SEGMENT_GET_MY_SETTINGS)
                .appendQueryParameter(KEY_TEAM_ID, Integer.toString(teamId))
                .build();
    }

    public static Uri getUpdateNotificationSettingUri(int teamId, int notificationSetting) {
        return new Uri.Builder()
                .authority(AUTHORITY)
                .appendEncodedPath(SEGMENT_FEED)
    ...
    public static Uri getTopicPinUri(String topicId) {
        return new Uri.Builder()
                .authority(AUTHORITY)
                .appendEncodedPath(SEGMENT_FEED)
                .appendEncodedPath(SEGMENT_GET_PIN)
                .appendQueryParameter(KEY_ID, topicId)
                .build();
    }

    public static Uri getUpdateTopicUri(String topicId, int myPin) {
        return new Uri.Builder()
                .authority(AUTHORITY)
                .appendEncodedPath(SEGMENT_FEED)
                .appendEncodedPath(SEGMENT_SET_PIN)
                .appendQueryParameter(KEY_ID, topicId)
                .appendQueryParameter(KEY_MY_PIN, Integer.toString(myPin))
                .build();
    }
