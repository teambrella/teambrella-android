...
//                        DumpedPrivateKey dpk = DumpedPrivateKey.fromBase58(null, "L4TzGwABRFtqGBtrbKxK1ZHEByi3GczUhztEx9dtPvXkuAzGKGdo"); //eugene
//                        mKey = dpk.getKey();
//
//                        String cosAddr = "0x7faea7bf543f36dae9d379c67979ef10c824f3fc";
//                        int opNum = 1;
//                        int teamId = 0;
//
//                        byte[] h = getTransferDataHash(teamId, opNum, new String[]{cosAddr}, new long[]{ 1_000_000_000_000_000_000L });
//                        Log.e(LOG_TAG, "hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh");
//                        Log.e(LOG_TAG, Hex.fromBytes(h));
//
//                        EtherAccount eth = new EtherAccount(mKey, getApplicationContext());
//                        byte[] sig = eth.signHashAndCalculateV(h);
//                        Log.e(LOG_TAG, Hex.fromBytes(h));
//
//                        Log.e(LOG_TAG, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
//                        Log.e(LOG_TAG, AbiArguments.encodeToHexString(1, new String[]{cosAddr}, new long[]{1_000_000_000_000_000_000L}, 0, 1, 2, sig, sig, sig));
//
//                        org.ethereum.geth.Transaction tx =
//                        eth.newMessageTx(0x2a, 500_000, "0xcBA8950DfCF4cC1E7FcBeC59F5360E95a3CB8205", true, METHOD_ID_TRANSFER, 1, new String[]{cosAddr}, new long[]{1_000_000_000_000_000_000L}, 0, 1, 2, sig, sig, sig);
//                        Log.e(LOG_TAG, "tttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt");
//                        Log.e(LOG_TAG, tx.encodeJSON());
//
//                        tx = eth.signTx(tx, true);
//                        //publishCryptoTx(tx);
//
//                        Transaction tx = new Tx();
//                        Tx
//                        tx.
...
//        return !operations.isEmpty();
    ...
    private String createNewWalletData(long teamId, String[] addresses) {
        int n = addresses.length;
        String contractV002 = "";
